...
#include <bbblue_bot_hw_iface.h>

void controlLoop(BBBlueBotHWIFace &hw, controller_manager::ControllerManager &cm, std::chrono::system_clock::time_point &last_time)
{
...
{
    ros::init(argc, argv, "bbblue_bot_base_node");
